      ...
      <ul className="nav nav-pills p-3 bg-white mb-3 rounded-pill align-items-center">
        <li className="nav-item">
          ...
          >
            ...
            <span className="d-none d-md-block"> Все записи </span>
          </a>
        </li>
        ...
        <li className="nav-item ml-auto">
          ...
          >
            ...
            <span className="d-none d-md-block font-14" > Создать запись </span>
          </a> </li> : <a>
          </a>}
        ...
        {!sessionStorage.getItem("email") ?
          <li className="nav-item mr-auto">
            ...
            >
              ...
              <span className="d-none d-md-block font-14" > Войти </span>
            </a>
          </li>
            :
            <li className="nav-item mr-auto">
            ...
            >
              <i className="fas fa-sign-in m-1" />
              <span className="d-none d-md-block font-14" > Выйти </span>
            </a>
          </li>}
  </ul>
